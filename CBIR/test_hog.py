"""
Test script for the HOG Features extractor.
"""
...
def test_hog_extractor():
    """Test the HOG Features extractor."""
    
    print("="*60)
    print("Testing HOG Features Extractor")
    print("="*60)
    ...
    print(f"   Resize shape: {extractor.resize_shape}")
